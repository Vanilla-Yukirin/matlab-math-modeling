...
\begin{frame}[fragile]{什么是非线性规划}
  \small 线性规划问题 = 规划问题 + 非线性的目标函数或约束。
  
  \scriptsize 在上一节初级班中，王学长已经讲过如何使用 lingo 求解线性规划问题。我也觉得对于简单的线性规划问题而言，lingo 是一个更好的选择。所以这节课就直接介绍非线性规划问题及其求解方法。
...
\begin{itemize}\scriptsize
  \item 求函数的极小值/极大值
  \item 求函数在一定区域内的极值
  \item 求函数在一定区域且满足特定条件下的极值
\end{itemize}
\end{frame}


\begin{frame}[fragile]{非线性规划问题简单例题}
